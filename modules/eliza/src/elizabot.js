...
// Added model property and changed to node module by Sascha Wolter (http://wolter.biz), 2019-06-19
function ElizaBot(noRandomFlag, model) {
	this.model = model;
...
ElizaBot.prototype.reset = function() {
	var elizaKeywords = this.model.elizaKeywords;
	this.quit=false;
	this.mem=[];
	this.lastchoice=[];
...
ElizaBot.prototype._init = function() {
	...
	var elizaSynons = this.model.elizaSynons;
	var elizaKeywords = this.model.elizaKeywords;
	var elizaPres = this.model.elizaPres;
	var elizaPosts = this.model.elizaPosts;
	var elizaQuits = this.model.elizaQuits;
...
ElizaBot.prototype._postTransform = function(s) {
	...
	var elizaPostTransforms = this.model.elizaPostTransforms;
